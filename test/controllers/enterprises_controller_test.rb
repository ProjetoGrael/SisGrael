...
class Financial::EnterprisesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { name: @enterprise.name, kind: @enterprise.kind } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { name: @enterprise.name, kind: @enterprise.kind } }

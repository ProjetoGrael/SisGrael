...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference('Occurrence.count') do
      post occurrences_url, params: { occurrence: { description: @occurrence.description, student_id: @occurrence.student_id, user_id: @occurrence.user_id } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { description: @occurrence.description, student_id: @occurrence.student_id, user_id: @occurrence.user_id } }

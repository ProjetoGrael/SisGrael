...
class Financial::InstitutionsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { kind: @institution.kind, name: @institution.name } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { kind: @institution.kind, name: @institution.name } }
